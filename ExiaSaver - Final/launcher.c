...
void choix ()
{
    ...
    if (nbr1==1)
    {
    	execl("/home/zz/Bureau/EXIASAVER/EXIASAVER_HOME/SAVER 1/statique","statique", 0, 0);
    }
    else if (nbr1==2)
    {
    	execl("/home/zz/Bureau/EXIASAVER/EXIASAVER_HOME/SAVER 2/dynamique1","dynamique1", 0, 0);
    }
}
void randomm ()
{
