...
void printf_center (const char* str) //block servant a centrer l'image en hauteur et en largeur, grace a un alcul selon le nombre de ligne et de colonne
{
    int n;
    for (n=0; n< (Longueur_console-strlen(str))/2; n++)
    {
        putchar('\n');
    }
